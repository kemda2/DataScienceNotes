...
# Aktivite Örneği: Tableau Public'te Etkileşimli Bir Gösterge Paneli Oluşturma

Aşağıda, bu etkinlik için tamamlanmış bir örnek ve bu örneğin beklentileri nasıl karşıladığının açıklaması yer almaktadır.

## Tamamlanmış Örnek

Bu ders öğesi için örneği incelemek isterseniz, aşağıdaki bağlantıya tıklayın.

Örnek bağlantısı: [2017 - 2018'de Tatillerin Seul Bisiklet Kiralamalarına Etkisi](https://public.tableau.com/app/profile/grow.with.google/viz/ImpactofHolidaysonSeoulBikeRentalsin2017-2018/Dashboard1)

## Örneğin Değerlendirmesi

Örneği kendi tamamladığınız etkinlikle karşılaştırın. Her bir ölçütü gözden geçirerek çalışmanızı değerlendirin. Neleri iyi yaptınız? Nerelerde gelişebilirsiniz? Bu sorulara vereceğiniz cevapları, kurs boyunca ilerlerken yol gösterici olarak kullanın.

***Not:*** *Bu örnek, veri görselleştirme etkinliğini tamamlama yollarından sadece birini temsil eder. Sizin çalışmanız bazı yönlerden farklılık gösterebilir. Önemli olan, veri görselleştirmenizin iş senaryosundaki kriterleri karşılamasıdır.*

### Örneğin Kriterleri Nasıl Karşıladığı

Tableau Public’e yüklenen örneğin verilen senaryodaki ayrıntılara nasıl uygun şekilde yanıt verdiğine dikkat edin:

* Veri gösterge paneli iki dinamik çalışma sayfası içeriyor.
* Gösterge paneli verileri iki farklı çubuk grafikle ayırıyor: Haftanın Gününe Göre ve Komşu Güne Göre.
* Bir çalışma sayfası verileri tarih ve aylara göre ayırıyor.
* Bu çalışma sayfası “Komşu Güne Göre” çalışma sayfasıdır.
* Diğer çalışma sayfası, verileri haftanın her günü için tarihlere göre ayırıyor. Bu sayfa “Haftanın Gününe Göre” sayfasıdır.
* Gösterge paneli, çalışma sayfaları ve filtreler düzgün şekilde etiketlenmiştir.
* Tatiller belirgin şekilde zıt bir renkte gösterilmiştir. Tatil verileri turuncu, tatil olmayan veriler mavidir.
* Gösterge panelinin kenar çubuğundaki filtreler istenen verileri filtrelemektedir.
* İki filtre ve bir açıklama kutusu (legend) vardır.
* Bir filtre, “Komşu Güne Göre” verisine bağlıdır ve verilerin aya göre filtrelenmesini sağlar.
* Diğer filtre, “Haftanın Gününe Göre” verisine bağlıdır ve verilerin haftanın gününe göre filtrelenmesini sağlar.
* Açıklama kutusu tatillerin turuncu, tatil olmayanların mavi olduğunu göstermektedir.
